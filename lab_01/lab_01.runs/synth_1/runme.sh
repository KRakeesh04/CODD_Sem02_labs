...
HD_PWD='/home/k_rakeesh/Documents/CACD_labs/lab_01/lab_01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab01_signals.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab01_signals.tcl
