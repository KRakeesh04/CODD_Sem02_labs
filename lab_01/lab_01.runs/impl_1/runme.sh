...
HD_PWD='/home/k_rakeesh/Documents/CACD_labs/lab_01/lab_01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab01_signals.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab01_signals.tcl -notrace
