...
HD_PWD='/home/k_rakeesh/Documents/CACD_labs/lab_03/lab_03.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab03_RCA_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab03_RCA_4.tcl
