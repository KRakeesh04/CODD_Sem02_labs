...
HD_PWD='/home/k_rakeesh/Documents/CACD_labs/lab_03/lab_03.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab03_RCA_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab03_RCA_4.tcl -notrace
