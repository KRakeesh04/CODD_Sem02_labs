...
HD_PWD='/home/k_rakeesh/Documents/CACD_labs/lab_02/lab_02.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_02.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_02.tcl
