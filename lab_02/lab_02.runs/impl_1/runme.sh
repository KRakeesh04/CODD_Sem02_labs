...
HD_PWD='/home/k_rakeesh/Documents/CACD_labs/lab_02/lab_02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_02.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_02.tcl -notrace
